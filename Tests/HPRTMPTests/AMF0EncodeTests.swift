...
final class AMF0EncodeTests: XCTestCase {
  ...
  func testEncoding() {
    // Number
    XCTAssertEqual(123.amf0Value, Data([0x00, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x5e, 0x40]))
...
//        XCTAssertEqual(object.amf0Encode, Data([0x03, 0x00, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x00, 0x04, 0x4a, 0x6f, 0x68, 0x6e, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x03, 0x61, 0x67, 0x65, 0x00, 0x00, 0x00, 0x1e]))
        
  }
  
//  func testArrayAMF0Encode() {
//    // Simple array with Int, String, and Double values
//    let array: [Any] = [1, "two", 3.0]
//    XCTAssertEqual(array.amf0Value, Data([0x0a, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x40]))
//
//    // Array of dictionaries
//    let dict1: [String: Any] = ["name": "John", "age": 30]
//    let dict2: [String: Any] = ["name": "Jane", "age": 25]
//    let array2 = [dict1, dict2]
//    let expectedData = Data([0x0a, 0x00, 0x00, 0x00, 0x02, 0x03, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x00, 0x04, 0x4a, 0x6f, 0x68, 0x6e, 0x00, 0x03, 0x61, 0x67, 0x65, 0x00, 0x1e, 0x03, 0x6e, 0x61, 0x6d, 0x65, 0x02, 0x00, 0x04, 0x4a, 0x61, 0x6e, 0x65, 0x00, 0x03, 0x61, 0x67, 0x65, 0x00, 0x19])
